...
def list_deposits(proposal_id: str) -> list[dict[str, Any]]:
    return qall(
        ...
        "sent_to_beneficiary, sent_to_bank, sent_to_routing, sent_to_account, submitted_at "
